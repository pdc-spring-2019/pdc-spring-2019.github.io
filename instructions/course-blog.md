...
3. Verify that a new link titled "Admin" now appears in the menu. 

NOTE: If the link does not appear and you are brought to a screen that says "you must receive approval to create or edit content," inform me in class. This warning message means I have not yet approved your Github username, which could be a mistake on my end or an issue with the Github username you provided when you filled out the Background and Interests Survey. If you have not completed the Background and Interests Survey, do so immediately.    
